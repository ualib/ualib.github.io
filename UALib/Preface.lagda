...
The main repository for the [UAlib][] is [gitlab.com/ualib/ualib.gitlab.io][]. There are more installation instructions in the [README.md](https://gitlab.com/ualib/ualib.gitlab.io/README.md) file of the [UniversalAlgebra repository](https://gitlab.com/ualib/ualib.gitlab.io), but a summary of what's required is
...
Instructions for installing each of these are available in the [README.md](https://gitlab.com/ualib/ualib.gitlab.io/README.md) file of the [UniversalAlgebra repository](https://gitlab.com/ualib/ualib.gitlab.io).
